...
firstBtn.addEventListener("click", () => {
    ...
    innerBanner.style.backgroundImage = `url(${'../../img/icon/first.jpg'})`;

    innerBanner.classList.add("first")
})
secondBtn.addEventListener("click", () => {
    headerTitle.textContent = "漸層"
    headerContent.textContent = "選擇一個深色作為起點。這個深色可以是你喜歡的任何颜色，這個深色作為整個漸層的基礎，為整個設計提供了深度和鲜明度。"
    innerBanner.style.backgroundImage = `url(${'../../img/icon/second.jpg'})`;
...
thirdBtn.addEventListener("click", () => {
    ...
    innerBanner.style.backgroundImage = `url(${'../../img/icon/third.jpg'})`;
